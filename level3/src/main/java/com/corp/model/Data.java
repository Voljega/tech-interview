...
public class Data {
    ...
    private List<DeliveryFee> deliveryFees = new Vector();//threadsafe
    // best to use TreeSet with Discount impl. Comparable but easier for testing
    private List<Discount> discounts = new Vector<>();
    ...
    public Map<Long, Article> getArticlesById() {
        return articlesById;
    }

    public void setArticlesById(Map<Long, Article> articlesById) {
